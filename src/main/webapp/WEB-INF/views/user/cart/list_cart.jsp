	...
	<table class="table table-bordered table-condensed">
              ...
              <tbody>
				...
				<c:forEach var="item" items="${ Cart }">
					<tr>
	                  <td><img width="100" src="${item.value.product.img }" alt=""></td>
	                  <td>${item.value.product.name }<br><br>Năm sản xuất: ${item.value.product.year }<br><br>Nhà sản xuất: ${item.value.product.brand_name }</td>

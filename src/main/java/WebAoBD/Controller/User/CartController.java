...
import WebAoBD.Service.User.BillServiceImpl;
import WebAoBD.Service.User.CartServiceImpl;
...
public class CartController extends BaseController{
	...
	public ModelAndView Index() {
		...
		_mvShare.addObject("lastProduct", _homeService.GetLastProduct());
//		_mvShare.addObject("brand", _homeService.getBrands());
	...
	public String CheckOutBill(HttpServletRequest request, HttpSession session, @ModelAttribute("bill") Bill bill) {
		...
		bill.setToltal(Double.parseDouble((String)session.getAttribute("TotalPriceCart")));
